...
public class SubSets {
	  ...
	  public List<List<Integer>> subsetsWithDup(int[] nums) {
	      ...
	      result = (ArrayList<List<Integer>>) uniqueSets(result, nums);
	  ...
	  private List<List<Integer>> uniqueSets(List<List<Integer>> result, int [] nums){
		  ...
		  for(List<Integer> l: result){
			  ...
			  String patt = "";
			  for(Integer i : tempArr){ patt=patt+i; }
	  ...
	  public static void main(String args[]){
		  List<List<Integer>> l = new SubSets().subsetsWithDup(new int[]{1});
